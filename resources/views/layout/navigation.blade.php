              ...
              <nav id="mainnav" class="mainnav">
                  <ul class="menu">
                    <li class="{{request()->is('/') ? ' active' : ''}}">
                          <a href="/">HOME</a>
                          {{-- <ul class="submenu">
                              <li class="active"><a href="index.html">Homepage Style 1</a></li>
...
{{-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#"><h2>E.store</h2></a>
    ...
    <span class="collapse navbar-collapse" id="navbarNav" style="">
      <div class=" navbar-nav d-flex collapse navbar-collapse" id="navbarNav" style="">
        <div class="row">
  ...
  {{-- <div class="navbar navbar-default navbar-fixed top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        <a href="" class="navbar-brand">E.Collection</a>
      </div>
      <div class="d-flex justify-content-between">
        <div class="div">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="sr-only">Navigations</span>

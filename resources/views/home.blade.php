                            ...
                            <div class="owl-carousel owl-theme">
                                <article class="post clearfix">
                                    <div class="featured-post data-effect-item">
                                        <img src="images/blog/new-lastest-1-370x280.jpg" alt="image">
                                ...
                                <article class="post clearfix">
                                    <div class="featured-post data-effect-item">
                                        <img src="images/blog/new-lastest-2-370x280.jpg" alt="image">
                                        <div class="content-post text-center">
                                            <div class="title-post">
                                                <h2><a href="blog-detail.html">Trend Of 2018</a></h2>
                                            </div><!-- /.title-post -->
                                ...
                                <article class="post clearfix">
                                    <div class="featured-post data-effect-item">
                                        <img src="images/blog/new-lastest-3-370x280.jpg" alt="image">
                                        <div class="content-post text-center">
                                            <div class="title-post">
                                                <h2><a href="blog-detail.html">Trend Of 2018</a></h2>
                                            </div><!-- /.title-post -->
